INSERT INTO MEMBER (id, firstname, lastname, email, password, isAdmin)
VALUES ('9135f12e-1b66-4ee6-bbae-df37303cc154', 'Max', 'Muster','max@muster.ch','max1234', true);
...
INSERT INTO BOOKING (id, startDate, endDate, isAccepted, member_id, place_id)
