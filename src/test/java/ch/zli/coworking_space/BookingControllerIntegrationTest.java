...
public class BookingControllerIntegrationTest {
    ...
    // GET
    @Test
    @Description("Return all available bookings")
    ...
    // POST
    @Test
    @Description("Adding a booking with given member and room")
    ...
    public void bookingShouldBeUpdated() throws Exception {
        ...
        bookingEntity.setIsAccepted(true);
        ...
        if (placeRepository.findById(UUID.fromString("4be5f5bf-8eb5-44ea-8eb5-a5e807856d09")).isEmpty() || memberRepository.findById(UUID.fromString("9135f12e-1b66-4ee6-bbae-df37303cc154")).isEmpty()) {
            throw new Exception("Id couldn't be found!");
        }
